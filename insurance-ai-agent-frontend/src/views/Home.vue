  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">AI保险智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/insurance-master')">
        <div class="card-glow"></div>
        <div class="app-icon insurance-icon">📃️</div>
        <div class="app-info">
          <div class="app-title">AI保险知识大师</div>
          <div class="app-desc">保险咨询AI大师</div>
        </div>
      ...
      <div class="app-card" @click="navigateTo('/super-agent')">
        ...
        <div class="app-info">
          <div class="app-title">AI保险智能体</div>
...
// 设置页面标题和元数据
useHead({
  title: 'AI保险智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'AI保险智能体应用平台提供AI保险咨询对话机器人和AI保险智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI租房大师,AI助手,智能对话,,AI智能体,首页'
    }
  ]
})
